...
//
// Filename:  AS400JDBCDataSourceBeanInfoTestcase.java
//
...
import com.ibm.as400.access.AS400JDBCDataSourceBeanInfo;

import test.Testcase;

/**
 * Testcase AS400JDBCDataSourceBeanInfoTestcase.
 **/
public class AS400JDBCDataSourceBeanInfoTestcase extends Testcase {
  ...
  /**
   * Constructor. This is called from the AS400JDBCDataSourcePropertiesTest
   * constructor.
   **/
  public AS400JDBCDataSourceBeanInfoTestcase(AS400 systemObject, Vector<String> variationsToRun, int runMode,
      FileOutputStream fileOutputStream,

      String password) {
    super(systemObject, "AS400JDBCDataSourceBeanInfoTestcase", variationsToRun, runMode, fileOutputStream, password);
  }
  ...
  /**
   * Verify the constructor, AS400JDBCDataSourceBeanInfo(). <br>
   * Expected results:
   * <ul>
  ...
  /**
   * Verify AS400JDBCDataSourceBeanInfo::getBeanDescriptor(). <br>
   * Expected results:
   * <ul>
   * <li>BeanDescriptor.getBeanClass() will return
   * "com.ibm.as400.AS400JDBCDataSource".
  ...
  /**
   * Verify AS400JDBCDataSourceBeanInfo::getDefaultEventIndex(). <br>
   * Expected results:
   * <ul>
  ...
  /**
   * Verify AS400JDBCDataSourceBeanInfo::getDefaultPropertyIndex(). <br>
   * Expected results:
   * <ul>
   * <li>0 will be returned.
   * </ul>
  ...
  /**
   * Verify AS400JDBCDataSourceBeanInfo::getEventSetDescriptors(). <br>
   * Expected results:
   * <ul>
  ...
  /**
   * Verify AS400JDBCDataSourceBeanInfo::getXIcon(int). <br>
   * Expected results:
   * <ul>
  ...
  /**
   * Verify AS400JDBCDataSourceBeanInfo::getPropertyDescriptors(). <br>
   * Expected results:
   * <ul>
   * <li>An array of size 44 will be returned.
  ...
  public void Var007() {
    ...
    try {
      ...
      if (pd.length != expectedCount) {
        failMessage.append("Wrong number of property descriptors returned: " + String.valueOf(pd.length) + " sb "
            + expectedCount + " \n");
        passed = false;
      }
